...
export class AppRouteReuseStrategy implements RouteReuseStrategy {
  ...
  retrieve(route: ActivatedRouteSnapshot): DetachedRouteHandle {
    ...
    console.log("retrieving", "return: ", this.storedRoutes[key]);
  ...
  */
  shouldAttach(route: ActivatedRouteSnapshot): boolean {
    ...
    if (canAttach) {
      ...
      console.log(this.compareObjects(route.params, this.storedRoutes[key].snapshot.params));
      console.log("query param comparison");
      console.log(this.compareObjects(route.queryParams, this.storedRoutes[key].snapshot.queryParams));

      let paramsMatch: boolean = this.compareObjects(route.params, this.storedRoutes[key].snapshot.params);
      let queryParamsMatch: boolean = this.compareObjects(route.queryParams, this.storedRoutes[key].snapshot.queryParams);

      console.log("deciding to attach...", route, "does it match?", this.storedRoutes[key].snapshot, "return: ", paramsMatch && queryParamsMatch);
